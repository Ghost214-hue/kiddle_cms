    ...
    >
      <div className={cardClasses}>
        ...
        <div className="p-3.5 pb-4 px-4">
          ...
          {/* Title */}
          <div className="text-sm font-['Playfair_Display',serif] font-semibold text-amber-950 leading-tight mb-0.5 line-clamp-2">
            {title}
          </div>

          {/* Author */}
          <div className="text-[11.5px] text-amber-600/70 font-['DM_Sans',sans-serif] mb-2 truncate">
            by {author}
          </div>
          ...
          <div className="flex items-center justify-between gap-2">
            ...
            <button onClick={handleAdd} className={addButtonClasses}>
              {added ? (
                <>
          ...
          <div className="flex items-center gap-1 mt-2.5">
            <span className="text-[11px] text-amber-700 font-semibold font-['DM_Sans',sans-serif]">
              Shop Deal
            </span>
