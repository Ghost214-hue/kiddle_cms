...
function KiddleLogo({ size = "md" }) {
  ...
  return (
    <a href="/" className="flex items-center no-underline flex-shrink-0 group">
      {logoSrc && !imgError ? (
        <img
          src={logoSrc}
          alt="Kiddle Bookshop"
          ...
          <div className="flex items-center justify-between h-20 gap-3">
            ...
            <div className="hidden md:flex items-center gap-[7px]">
              ...
              <button
                aria-label="Account"
                title="Account"
                className="w-[38px] h-[38px] rounded-full border-[1.5px] border-[rgba(20,10,2,0.16)] bg-[rgba(232,215,192,0.85)] flex items-center justify-center cursor-pointer overflow-hidden shadow-[inset_0_1px_0_rgba(255,255,255,0.5)] transition-colors duration-200 hover:border-[rgba(20,10,2,0.35)]"
              >
                ...
                {[
                  {
                    w: "w-4",
                    rotate: menuOpen
                      ? "rotate-45 translate-x-[4.5px] translate-y-[4.5px]"
                      : "",
                  },
                  {
                    w: "w-3",
          ...
          <div className="flex justify-center gap-2.5">
            {[
              ...
              <a
                ...
                href="#"
                aria-label={s.label}
                className="w-[34px] h-[34px] rounded-full border border-[rgba(20,10,2,0.14)] bg-[rgba(255,252,246,0.6)] flex items-center justify-center text-[#3d2a18] no-underline transition-all duration-200 hover:text-[#1a1008] hover:bg-[rgba(20,10,2,0.08)]"
              >
                <svg width="13" height="13" viewBox={s.vb} fill="none">
                  {s.d}
                </svg>
              </a>
            ))}
