  ...
  return (
    <span className="inline-flex gap-0.5">
      {[1, 2, 3, 4, 5].map((i) => (
        <span
          key={i}
          className={`text-[11px] ${i <= Math.round(rating) ? "text-[#a0693a]" : "text-gray-300"}`}
        >
          ★
        </span>
      ))}
...
export default function WishlistPage() {
  ...
  if (!wishlist || wishlist.length === 0) {
    return (
      <div className="bg-[#f5f0e8] min-h-screen pt-32 pb-20">
        <div className="px-[clamp(48px,6vw,100px)] text-center">
  ...
  return (
    <div className="bg-[#f5f0e8] min-h-screen pt-28 pb-20">
      <div className="px-[clamp(48px,6vw,100px)]">
        {/* Header */}
